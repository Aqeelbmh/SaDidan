...
const Timeline = () => {
  ...
  const fallbackExperience = [
    {
      ...
      place: "UNSIKA",
      details:
        "Courses: Environmental Ecology, GIS, Environmental Management Systems, Digital Literacy, Artificial Intelligence",
    ...
    },
    {
      ...
      details:
        "Conducting environmental impact assessments & compliance documentation",
  ...
  const currentData =
    activeTab === "education" ? fallbackEducation : fallbackExperience;
                  ...
                  >
                    <div className="glass neon-border rounded-2xl p-4 sm:p-6 backdrop-blur-xl shadow-neon hover:scale-105 transition-transform duration-300">
                      ...
                      <div className="flex items-start gap-4">
                        <div
                          className={`w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-r ${item.color} rounded-xl flex items-center justify-center shadow-lg flex-shrink-0`}
                        >
                          {item.icon}
                        </div>
