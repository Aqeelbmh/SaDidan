...
const galleryItems = [
  {
    ...
    description:
      "Conducting biodiversity surveys and carbon stock assessments in coastal mangrove habitats.",
    category: "Research",
    image: "🌊",
  },
  {
    ...
    description:
      "Leading comprehensive EIA studies for sustainable infrastructure development projects.",
    category: "Consulting",
    image: "📊",
  },
  {
    ...
    description:
      "Engaging with local communities to promote environmental awareness and sustainable practices.",
    category: "Education",
    image: "👥",
  },
  {
    ...
    description:
      "Developing and implementing sustainable waste management solutions for urban areas.",
    category: "Innovation",
    image: "♻️",
  },
  {
    ...
    description:
      "Working on species protection and habitat restoration in protected areas.",
  ...
  },
  {
    ...
    description:
      "Designing resilience strategies for communities vulnerable to climate change impacts.",
    category: "Policy",
    image: "🌱",
  },
  {
    ...
    description:
      "Collaborating with international researchers on environmental science projects.",
    category: "Research",
    image: "🔬",
  },
  {
    ...
    description:
      "Implementing green infrastructure and sustainable development initiatives.",
      ...
      <div className="relative z-20 container-responsive">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-yellow-100 mt-4 sm:mt-6 max-w-3xl mx-auto px-4">
            A visual journey through environmental research, conservation
            efforts, and sustainable development projects
          </p>
        </div>
        ...
        <div className="text-center mt-12 sm:mt-16">
          <div className="bg-gradient-to-r from-white/10 to-yellow-300/10 rounded-xl p-6 sm:p-8 backdrop-blur-xl glassmorphism border border-yellow-300/20">
            ...
            <p className="text-yellow-100 mb-4 sm:mb-6 max-w-2xl mx-auto text-sm sm:text-base">
              Explore more of my work, research projects, and environmental
              initiatives through my detailed portfolio.
            </p>
